...
def test_loose_text_next_to_block_is_wrapped(render):
    """Голый текстовый узел рядом со списком не получает никаких отступов: `.body p`
    задаёт их абзацу, а анонимному блоку задать нечего — текст слипался бы со списком."""
